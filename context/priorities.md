...
- Engagement model: Justin works primarily with **Cherity** (proposes solutions/directions to her). **Jon is Terraplex's CEO** — added Terraplex budget needs his blessing, but Cherity carries that up; it's not a Justin-managed gate. Include Jon in BrandOS demos and gauge his involvement as Terraplex-focused features land. Terraplex is the **proof of concept**; BrandOS will host other distributors. (Revolution/Russell is dormant.) See core memory `project_terraplex_engagement_model`.
