...
- [x] **HUB-06** (DERIVED): Every write emits a Receipt feed entry (timestamp, kind, project, absolute file path, excerpt) visible to the operator on Home and on the relevant Project page — *Capture + chat_drop + chat_session_close receipts delivered (Plans 04-05, 04-08); wiki_ingest receipt pending (04-09)*
