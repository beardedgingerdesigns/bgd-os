...
- [ ] **STATE-03**: Hook is gated on session substance (skips trivial sessions based on edits/messages/commits threshold)
...
### To-Do List (TODO)
- [ ] **TODO-01**: Persistent to-do list stored as first-class AIOS artifact in claude-os
- [ ] **TODO-02**: Action items generated by triage persist until completed
- [ ] **TODO-03**: Operator can manually add action items
- [ ] **TODO-04**: Email threads managed by triage are ephemeral (not stored in to-do list)
...
- [ ] **SKILL-01**: Retire `/load-project` skill
