...
// Pure envelope parser lives in todos-envelope.ts so client components (triage-output.tsx)
// can use it without bundling child_process. Re-exported below for server consumers.
export { extractTodosEnvelope } from '@/lib/skills/todos-envelope'
...
//
// Parser moved to lib/skills/todos-envelope.ts (pure module, client-safe).
// Re-exported at top of file for backwards compatibility with server consumers.
